...
class ApiService {
  ...
  static getHorariosOcupados(int idGroomer, String fecha) => get('/citas/horarios_ocupados/$idGroomer/$fecha');
  ...
  static cerrarFicha(int id, [List<Map<String, dynamic>>? checklist]) => post('/grooming/fichas/$id/cerrar', {'checklist_items': checklist ?? []});
  ...
  static getLogInsumos() => get('/grooming/insumos/log');
